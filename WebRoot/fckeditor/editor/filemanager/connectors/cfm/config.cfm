...
<cfscript>
	...
	// Perform additional checks for img files - if set to true, validate img size
	...
	Config.ConfigAllowedTypes 				= "File,img,Flash,Media" ;
...
//		Attention: It must end with a slash: '/'
	...
	Config.AllowedExtensions["img"] 		= "bmp,gif,jpeg,jpg,png" ;
	Config.DeniedExtensions["img"] 		= "" ;
	Config.FileTypesPath["img"] 			= Config.UserFilesPath & 'img/' ;
	Config.FileTypesAbsolutePath["img"] 	= iif( Config.ServerPath eq "", de(""), de(Config.ServerPath & 'img/') ) ;
