...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		AllowedTypes = new string[] { "File", "img", "Flash", "Media" };
		...
		TypeConfig[ "img" ].AllowedExtensions			= new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
		TypeConfig[ "img" ].DeniedExtensions			= new string[] { };
		TypeConfig[ "img" ].FilesPath					= "%UserFilesPath%img/";
		TypeConfig[ "img" ].FilesAbsolutePath			= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%img/" );
		TypeConfig[ "img" ].QuickUploadPath			= "%UserFilesPath%";
		TypeConfig[ "img" ].QuickUploadAbsolutePath	= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%" );
