...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'img'			: oItem = new FCKToolbarButton( 'img'			, FCKLang.InsertimgLbl, FCKLang.Insertimg, null, false, true, 37 ) ; break ;
		...
		case 'imgButton'		: oItem = new FCKToolbarButton( 'imgButton'	, FCKLang.imgButton, null, null, null, null, 55 ) ; break ;
