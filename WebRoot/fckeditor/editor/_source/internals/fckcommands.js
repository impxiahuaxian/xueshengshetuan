...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'img'		: oCommand = new FCKDialogCommand( 'img'		, FCKLang.DlgImgTitle			, 'dialog/fck_img.html'		, 450, 390 ) ; break ;
		...
		case 'imgButton'	: oCommand = new FCKDialogCommand( 'imgButton', FCKLang.imgButton	, 'dialog/fck_img.html?imgButton', 450, 390 ) ; break ;
