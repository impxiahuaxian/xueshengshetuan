...
>
	...
	lConfigKeys = lConfigKeys & ",LinkDlgHideTarget,LinkDlgHideAdvanced,imgDlgHideLink,imgDlgHideAdvanced,FlashDlgHideAdvanced";
	lConfigKeys = lConfigKeys & ",ProtectedTags,BodyId,BodyClass,DefaultLinkTarget,CleanWordKeepsStructure";
	lConfigKeys = lConfigKeys & ",LinkBrowser,LinkBrowserURL,LinkBrowserWindowWidth,LinkBrowserWindowHeight,imgBrowser";
	lConfigKeys = lConfigKeys & ",imgBrowserURL,imgBrowserWindowWidth,imgBrowserWindowHeight,FlashBrowser,FlashBrowserURL";
	lConfigKeys = lConfigKeys & ",FlashBrowserWindowWidth,FlashBrowserWindowHeight,LinkUpload,LinkUploadURL,LinkUploadWindowWidth";
	lConfigKeys = lConfigKeys & ",LinkUploadWindowHeight,LinkUploadAllowedExtensions,LinkUploadDeniedExtensions,imgUpload,imgUploadURL";
	lConfigKeys = lConfigKeys & ",imgUploadAllowedExtensions,imgUploadDeniedExtensions,FlashUpload,FlashUploadURL,FlashUploadAllowedExtensions";
